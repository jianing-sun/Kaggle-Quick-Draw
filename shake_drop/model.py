...
class ShakeDropNet(nn.Module):
    ...
    def pyramidal_make_layer(self, block, block_depth, stride=1):
        ...
        layers.append(
            block(self.input_featuremap_dim, int(round(self.featuremap_dim)), stride, self.drop_prob, downsample))
...
def shake_drop_net(**kwargs):
    model = ShakeDropNet(depth=50, alpha=84, num_classes=340, **kwargs)
    return model
